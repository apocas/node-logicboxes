...
Domains.prototype.gdprDisable = function (options, callback) {
  utils.modem('api/domains/gdpr/disable.json', 'POST', options, this.config, function(err, data) {
    callback(err, data);
  });
};

Domains.prototype.gdprEnable = function (options, callback) {
  utils.modem('api/domains/gdpr/enable.json', 'POST', options, this.config, function(err, data) {
    callback(err, data);
  });
};
